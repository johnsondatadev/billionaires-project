...
# outcome <- predictor_1 + predictor_2 + rnorm(n)
# data <- data.frame(predictor_1, predictor_2, outcome)

# Creating an interaction plot
interaction.plot(x.factor = Classbill$age, 
                 trace.factor = Classbill$selfMade, 
                 response = data$finalWorth, 
                 fun = mean, 
                 xlab = "age", 
                 ylab = "final worth", 
                 type = "b", 
...
```{r}
summary(lm(finalWorth ~ ., data = Classbill))
```
